...
import com.wpr.treeviewcore.model.TreeViewItem;
...
public class TreeViewAdapt extends BaseAdapter {
    ...
    //事件侦听
    private OnTreeViewCheckBoxChangeListener onTreeViewCheckBoxChangeListener = null;
    ...
    public TreeViewAdapt(Context context, TreeNode treeNode, ListView listView) {
        this.treeViewItemClassName = "com.wpr.treeviewcore.model.TreeViewItem";
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            item.setCheckBox((CheckBox) view.findViewById(R.id.tree_item_cb));
        ...
        if (node.isParent()) {
            item.getNodeIconView().setBackgroundResource(R.mipmap.folder);
        } else {
            item.getNodeIconView().setImageResource(R.mipmap.file);
        }
        ...
        //默认属性是指
        item.getCheckBox().setChecked(node.isChecked());

        //控制显隐
        setViewVisibleStatus(item.getNodeIconView(), !node.isNoNodeIcon());
        setViewVisibleStatus(item.getCheckBox(), !node.isNoCheck());
            ...
            this.treeView_lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    if (onItemClickListener != null) {
                        onItemClickListener.setOnItemClickListener(view, position, treeNodeArray.get(position));
                    }
                }
            });
...
//    region 事件
    ...
    public void setOnTreeViewCheckBoxChangeListener(OnTreeViewCheckBoxChangeListener listener) {
        this.onTreeViewCheckBoxChangeListener = listener;
    }
